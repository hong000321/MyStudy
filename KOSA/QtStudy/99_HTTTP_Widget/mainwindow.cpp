...
void MainWindow::sendHtmlResponse(QTcpSocket *socket, const QString &title,                                                        const QString &body)
{
...
void MainWindow::sendTextResponse(QTcpSocket *socket, const QString &text)
{
    QByteArray response;
    response.append("HTTP/1.1 200 OK\r\n");
